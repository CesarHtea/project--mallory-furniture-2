  ...
  render() {
    return (
    	<div className='terms'>
    		...
    		<h2 className='terms__subTitle'>Terms of Service</h2>
    		<p className='terms__text'>
				All buyers (hereinafter 'You' or 'User') need to register by creating a username and a password for login.<br/><br/>
